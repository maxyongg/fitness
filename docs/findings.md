...
- **Is the 50kg right-side ceiling pain-limited or caution-limited?** The `pain(R)`
  scores accumulating in `log.md` should answer this over time. This is the main reason
  the phone UI exists — screenshots can't supply that field.
